...
{
    public class NVT_QUAN_TRIController : Controller
    {
        ...
        // GET: NVT_QUAN_TRI/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: NVT_QUAN_TRI/Create
